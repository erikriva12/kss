        ...
        var t = $("#my-table").dataTable({
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    var htmls = `<img src="<?= base_url() ?>` + row['foto_utama'] + `" class="img-responsive" style="height: 150px;">`;
                    return htmls;
                }
            },
            {
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, row, meta) {
                    var htmls = `<a class="btn btn-primary btn-sm btn-block text-white" href="<?= base_url('produk/edit/') ?>` + row['id'] + `"><i class="fas fa-pencil-alt"></i> Edit</a>`;
                    return htmls;
                }
            }
            ],
