                ...
                <div class="card-header">
                    ...
                    <div class="col-md-4">
                        <div class="text-right">
                            <a href="<?= base_url('testimonial/tambah') ?>" class="btn btn-primary">
...
<script>
        ...
        var table_htmls = `<table class="table table-bordered table-striped table-hover" id="my-table">
            <thead class="bg-info">
                <tr>
                    ...
                    <th class="text-white">Isi Testimonial</th>
        ...
        var t = $("#my-table").dataTable({
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    var htmls = `<img src="<?= base_url() ?>` + row['foto'] + `" class="img-responsive" style="height: 150px;">`;
                    return htmls;
                }
            },
            {
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, row, meta) {
                    var htmls = `<a class="btn btn-primary btn-sm btn-block text-white" href="<?= base_url('testimonial/edit/') ?>` + row['id'] + `"><i class="fas fa-pencil-alt"></i> Edit</a>`;
                    return htmls;
                }
            }
            ],
    ...
    function deleteData(id) {
        Swal.fire({
            ...
            text: "Data yang dihapus tidak akan muncul pada section testimonial.",
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                mydata.append('id', id);
                $.ajax({
                    url: "<?= base_url('testimonial/hapus') ?>",
                    type: "POST",
                    data: mydata,
                    cache: false,
                    contentType: false,
    ...
    function restoreData(id) {
        Swal.fire({
            title: 'Apakah Anda Yakin?',
            text: "Data akan muncul kembali pada section testimonial.",
            icon: 'question',
            showCancelButton: 'Batal',
