    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">Edit Testimonial
                </div>
            </div>
        </div>
        <div class="section-body">
            <div class="card">
                <form action="<?= base_url('testimonial/update/') ?>" id="form-testimonial">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div id="preview-foto-about" class="my-1">
                                        <img src="<?= base_url($data->foto) ?>" class="img-responsive"
                                            style="height: 150px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="editor"
                                        name="isi_testimonial"><?= $data->isi_testimonial ?></textarea>
