                                ...
                                <div class="form-group">
                                    ...
                                    <table class="table table-bordered table-striped table-hover table-sm"
                                        ...
                                        <thead class="bg-info text-white text-center">
                                            <tr>
                                                <td style="width: 400px;"><b>Pertanyaan</b></td>
                                                <td><b>Jawaban</b></td>
                                                <td style="width: 50px">
                                                    <div class="btn btn-success btn-sm" onclick="addRowFAQ()"><i
                                                            class="fas fa-plus"></i></div>
                                                </td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($datameta->pertanyaan_faq as $key_counting => $val_counting): ?>
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control"
                                                            name="meta[pertanyaan_faq][]"
                                                            value="<?= $datameta->pertanyaan_faq[$key_counting] ?>"
                                                            placeholder="Contoh : Berapa Jangka Waktu Pengiriman">
                                                    </td>
                                                    <td>
                                                        <textarea class="editor"
                                                            name="meta[jawaban_faq][]"><?= $datameta->jawaban_faq[$key_counting] ?></textarea>
                                                    </td>
...
<script>
    ...
    function addRowFAQ() {
        var htmls = `<tr>
                                                    ...
                                                    <td>
                                                        <textarea class="editor" name="meta[jawaban_faq][]"></textarea>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="btn btn-danger btn-sm"
                                                            onclick="$(this).parent().parent().remove()">
