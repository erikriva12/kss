...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Kategori Section</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="<?= base_url() ?>">Dashboard</a></div>
                <div class="breadcrumb-item">Kategori Section</div>
            </div>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalKategori">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url('section/store-kategori') ?>" id="form-add-kategori">
...
<script>
    function getData() {
        ...
        var t = $("#my-table").dataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?= base_url('section/json_kategori') ?>",
                type: "POST"
            },
            columns: [{
                data: "id",
    ...
    function edit(id_kategori) {
        ...
        $('#edit-kategori').load("<?= base_url('section/edit-kategori/') ?>" + id_kategori);
    }
